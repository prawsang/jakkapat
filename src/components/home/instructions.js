                        ...
                        {type === 0 ? (
                            <div className="recipe">
                                ...
                                <InstItem image={image2} order={2}>
                                    ใส่ผงปรุงรสและเส้นก๋วยจั๊บญวนสด (หากไม่ชอบให้น้ำซุปข้น ควรล้างเส้นก่อนใส่เล้น) เพื่อเพิ่มคุณค่าทางโภชนาการ สามารถเติมเนื้อสัตว์ เช่น หมูยอ หมูสับ
                                </InstItem>
                                <InstItem image={image3} order={3}>
                                    ต้มต่อไปอีก 2-3 นาที
                                </InstItem>
                                <InstItem image={image4} order={4} last={true}>
                                    เทก๋วยจั๊บญวนใส่ภาชนะ ใส่หอมเจียว พริกผัด และเพื่อเพิ่มความอร่อยสามารถเติมผักต่าง ๆ เช่น ผักชีใบเลื่อย
                                </InstItem>
                            </div>
                        ) : (
                                <div className="recipe">
                                    ...
                                    <InstItem order={3}>
                                        ใส่เส้นก๋วยจั๊บญวนสด (หากไม่ชอบให้น้ำซุปข้น ควรล้างเส้นก่อนใส่เล้น)
                                </InstItem>
